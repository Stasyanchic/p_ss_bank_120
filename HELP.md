...
<li>создай от <code>develop</code> свою собственную ветку для выполнения взятой задачи. Свою ветку назови так, чтобы было понятно, чему посвящена задача. В начале имени ветки проставь наименование задачи и имя модуля. Например, <code>basic_structure_account</code></li>
...
<li>создай на своей ветке merge request, в теле реквеста укажи <code><i>Closes и имя своей ветки</i></code>. Например, <code>Closes basic_structure_account</code></li>
